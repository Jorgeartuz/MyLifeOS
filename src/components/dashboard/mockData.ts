import { type DashboardData, type Transaction } from '../../types/dashboard';
...
export const mockDashboardData: Record<string, DashboardData> = {
  hoy: {
    ...
    work: { income: 90000, deliveries: 12, kilometers: 74, hours: 7.5, fuelCost: 20000, otherCosts: 0 },
    moto: {
      model: 'AKT CR4 125',
      kilometers: 43205,
      status: 'Operativa',
  ...
  semana: {
    ...
    work: { income: 640000, deliveries: 84, kilometers: 420, hours: 45, fuelCost: 120000, otherCosts: 15000 },
    moto: {
      model: 'AKT CR4 125',
      kilometers: 43205,
      status: 'Operativa',
