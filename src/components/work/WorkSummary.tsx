...
export const WorkSummary = ({ data }: { data: WorkSummaryData }) => {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
      {/* Tarjeta Destacada de Ganancia Real */}
      <div className="bg-primary p-6 rounded-card text-white shadow-lg shadow-primary/20">
        ...
        <p className="text-[10px] mt-2 font-medium opacity-70">Ingreso neto del período</p>
      </div>
...
const SummaryCard = ({ title, value, icon, color, isNumeric }: SummaryCardProps) => (
